...
public @Test class ListComparatorTest {
    public static void main(String[] args) {
        System.out.print("Running " + ListComparatorTest.class.getSimpleName() + " ... ");

        ListComparatorTest test = new ListComparatorTest();
        test.testEquals();
    ...
    private void testEquals() {
        ListComparator comparator = ListComparator.getInstance();
